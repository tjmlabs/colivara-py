...
from colivara_py.api_response import ApiResponse, T as ApiResponseT
import colivara_py.models
from colivara_py import rest
from colivara_py.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(colivara_py.models, klass)
