...
class PageOutQuery(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.collection_metadata is None
            and "collection_metadata" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.document_metadata is None
            and "document_metadata" in self.model_fields_set
        ):
