...
class SearchImageIn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["img_base64", "collection_name", "top_k", "query_filter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchImageIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchImageIn from a dict"""
        if obj is None:
            return None
