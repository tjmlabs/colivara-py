...
class EmbeddingsApi:
    ...
    @validate_call
    def api_views_embeddings(
        self,
        embeddings_in: EmbeddingsIn,
        ...
        :param embeddings_in: (required)
        :type embeddings_in: EmbeddingsIn
        ...
        _param = self._api_views_embeddings_serialize(
    ...
    @validate_call
    def api_views_embeddings_with_http_info(
        self,
        embeddings_in: EmbeddingsIn,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_views_embeddings_without_preload_content(
        self,
        embeddings_in: EmbeddingsIn,
        _request_timeout: Union[
            None,
    ...
    def _api_views_embeddings_serialize(
        self,
        embeddings_in,
        _request_auth,
        _content_type,
