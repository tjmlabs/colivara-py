...
class WebhookApi:
    ...
    @validate_call
    def api_views_add_webhook(
        self,
        webhook_in: WebhookIn,
        ...
        :param webhook_in: (required)
        :type webhook_in: WebhookIn
        ...
        _param = self._api_views_add_webhook_serialize(
    ...
    @validate_call
    def api_views_add_webhook_with_http_info(
        self,
        webhook_in: WebhookIn,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_views_add_webhook_without_preload_content(
        self,
        webhook_in: WebhookIn,
        _request_timeout: Union[
            None,
    ...
    def _api_views_add_webhook_serialize(
        self,
        webhook_in,
        _request_auth,
        _content_type,
        ...
        if webhook_in is not None:
            _body_params = webhook_in
