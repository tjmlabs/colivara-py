...
class TestCollectionIn(unittest.TestCase):
    """CollectionIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionIn:
        """Test CollectionIn
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CollectionIn`
        """
        model = CollectionIn()
        if include_optional:
            return CollectionIn(
