...
class TestEmbeddingsOut(unittest.TestCase):
    """EmbeddingsOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmbeddingsOut:
        """Test EmbeddingsOut
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmbeddingsOut`
        """
        model = EmbeddingsOut()
        if include_optional:
            return EmbeddingsOut(
                ...
                model = '',
                usage = colivara_py.models.usage.Usage()
            )
        else:
            return EmbeddingsOut(
                data = [
