...
class TestPageOut(unittest.TestCase):
    """PageOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageOut:
        """Test PageOut
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PageOut`
        """
        model = PageOut()
        if include_optional:
            return PageOut(
