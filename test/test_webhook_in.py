...
class TestWebhookIn(unittest.TestCase):
    """WebhookIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIn:
        """Test WebhookIn
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WebhookIn`
        """
        model = WebhookIn()
        if include_optional:
            return WebhookIn(
